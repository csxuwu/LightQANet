...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='/home/wuxu/datasets/LL/LOL_v2/Real_captured/Test/Normal', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='/home/wuxu/codes/Retinexformer/results/LOL_v2_real', help='Path to restored images')
