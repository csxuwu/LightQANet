...
# ----------------------------------------------------
# 2024-09-27
# 用于训练 low-level filter，只有训练，没有验证、测试
# ----------------------------------------------------
...
def train_pipeline(root_path, opt_path):
    ...
    opt, args = parse_options(root_path, opt_path=opt_path, is_train=True, is_LPF=True)
    opt['root_path'] = root_path

    name = opt['name']
    # opt['name'] = f'LPF_{name}'
    # print(opt['name'])
...
if __name__ == '__main__':
    ...
    opt_path = r'/data/xuwu/codes/low_light/PromptEnhance/options/LPF/LPF_backbone.yaml'
